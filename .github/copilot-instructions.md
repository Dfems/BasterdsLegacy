...
> - **Non fermarti** finché *tutte* le funzionalità richieste non sono state **implementate e verificate**.
...
- Documentazione aggiornata e *Definition of Done* chiara.
...
- **Non usare `React.FC`.**
- Tipizza sempre **props, stato, return**. Evita `any`; usa `unknown` + *type guards* quando serve.
...
- **Preferisci Composition over Inheritance**; evita *God component* e *prop drilling* eccessivo (usa context mirati).
...
export default tseslint.config(
  ...
  ...tseslint.configs.stylisticTypeChecked,
  {
    ...
    rules: {
      ...
      'import/order': ['error', { 'newlines-between': 'always', alphabetize: { order: 'asc' }, pathGroups: [{ pattern: '@/**', group: 'internal' }] }],
