...
const translations: Translations = {
  it: {
    ...
    welcomePart:
      "Preparatevi a un'esperienza unica e imprevedibile: un immenso multiverso con qualche mod selezionata per rendere le cose ancora più... interessanti 😉",
    ...
    footer: '© Francisco Esteban Mosquera Sancan 2025. Tutti i diritti riservati.',
  ...
  en: {
    ...
    title: "Basterd's Legacy!",
    welcomePart:
      'Get ready for a unique and unpredictable experience: a huge multiverse with some selected mods to make things even more... interesting 😉',
    ...
    footer: '© Francisco Esteban Mosquera Sancan 2025. All rights reserved.',
  ...
  es: {
    ...
    title: "Basterd's Legacy",
    welcomePart:
      'Prepárense para una experiencia única e impredecible: un inmenso multiverso con algunos mods seleccionados para hacer las cosas aún más... interesantes 😉',
    ...
    footer: '© Francisco Esteban Mosquera Sancan 2025. Todos los derechos reservados.',
